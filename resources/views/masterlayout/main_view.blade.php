...
<head>
  ...
  <title>Finance Analyzing Software</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>Finance</b>Analyazer</span>
    </a>
      ...
      <ul class="sidebar-menu" data-widget="tree">
		...
		<li class="treeview">
          <a href="#">
            ...
            <span>Bin Insert</span>
            <span class="pull-right-container">
               <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="{{ route('admin.insertBin') }}"><i class="fa fa-circle-o"></i> Insert Bin </a></li>
          
            <li><a href="http://localhost/upayig/admin/syncbin"><i class="fa fa-circle-o"></i> Sync Bin 1</a></li>
          </ul>
        </li>
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-files-o"></i>
            <span>Bin Manage</span>
            <span class="pull-right-container">
               <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
		    <li><a href="{{ route('admin.allbin') }}"><i class="fa fa-circle-o"></i> All Bin </a></li>
            <li><a href=""><i class="fa fa-circle-o"></i> White List </a></li>
            <li><a href=""><i class="fa fa-circle-o"></i> Black List </a></li>
		 ...
		 <li class="treeview">
          <a href="#">
            <i class="fa fa-files-o"></i>
            <span>Blacklist Settings</span>
            <span class="pull-right-container">
               <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href=""><i class="fa fa-circle-o"></i> Bin  </a></li>
            <li><a href=""><i class="fa fa-circle-o"></i> Bank Issuer  </a></li>
          </ul>
        </li>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2020 <a href="#">Anonymous Lab</a>.</strong> All rights
    reserved.
  </footer>
